...
public class login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    String url = "http://eticaret.kirmizikaya.net/api/login";
    String veri_string;
    String usercase;
    /**
   ...
   class Post extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... unused) { // Arka Planda yapılacaklar. Yani Post işlemi
            ...
            params.add(new BasicNameValuePair("mail","m@m.com"));
            params.add(new BasicNameValuePair("sifre", "123456"));

            veri_string = this.httpPost(url, "GET", params, 20000); //PostClass daki httpPost metodunu çağırdık.Gelen string değerini aldık
        ...
        try {
            JSONObject reader = new JSONObject(veri_string);
            JSONObject data = reader.getJSONObject("data");
            usercase = data.getString("case");
        if(usercase=="1"){
            Intent intent=new Intent(login.this,MainActivity.class);
            startActivity(intent
            );
